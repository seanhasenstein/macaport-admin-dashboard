...
type Props = {
  ...
  firstEmployeeSelected: boolean;
  lastEmployeeSelected: boolean;
  setPrevItem: () => void;
  setNextItem: () => void;
...
export default function SelectedEmployee({
  ...
  const { _id, firstName, lastName, email, phone, createdAt, updatedAt } =
    selectedEmployee;

  return (
    <SelectedEmployeeStyles>
      <div className="body">
        <button
          type="button"
        ...
        <div className="item">
          ...
          <p className="value">{formatPhoneNumber(phone)}</p>
        </div>
        <div className="item">
      ...
      <div className="footer">
        <button
          ...
          disabled={firstEmployeeSelected}
          onClick={setPrevItem}
        >
...
const SelectedEmployeeStyles = styled.div`
  position: relative;
