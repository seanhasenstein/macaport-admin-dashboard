...
export default function CSVDownloadModal({
  ...
  const [fields, setFields] = React.useState(() => [
    ...
    { id: 8, field: 'uniqueItems', checked: true },
    { id: 9, field: 'totalItems', checked: true },
    { id: 10, field: 'orderStatus', checked: true },
    { id: 11, field: 'summary.subtotal', checked: true },
    { id: 12, field: 'summary.shipping', checked: true },
    { id: 13, field: 'summary.salesTax', checked: true },
    { id: 14, field: 'summary.total', checked: true },
    { id: 15, field: 'summary.stripeFee', checked: true },
    { id: 16, field: 'summary.netTotal', checked: true },
    { id: 17, field: 'shippingMethod', checked: true },
    ...(store?.hasPrimaryShippingLocation || store?.allowDirectShipping
      ? [
          ...
          { id: 21, field: 'shippingAddress.city', checked: true },
          { id: 22, field: 'shippingAddress.state', checked: true },
          { id: 23, field: 'shippingAddress.zipcode', checked: true },
        ]
      : []),
    { id: 24, field: 'stripeId', checked: true },
  ]);
