...
export default function CSVDownloadModal({
  ...
  const [fields, setFields] = React.useState(() => [
    ...
    { id: 8, field: 'orderItems', checked: true },
    { id: 9, field: 'uniqueItems', checked: true },
    { id: 10, field: 'totalItems', checked: true },
    { id: 11, field: 'orderStatus', checked: true },
    { id: 12, field: 'summary.subtotal', checked: true },
    { id: 13, field: 'summary.shipping', checked: true },
    { id: 14, field: 'summary.salesTax', checked: true },
    { id: 15, field: 'summary.total', checked: true },
